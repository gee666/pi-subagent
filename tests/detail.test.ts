  ...
  blocks: [
    {
      ...
      events: [
        ...
        { type: "children", toolName: "subagents", children: [{ name: "Maria", agent: "reviewer", task: "Review", status: "success" }] },
...
test("tool list is compact and tool detail contains full arguments and result", () => {
  ...
  const detail = renderToolDetailLines(block.events[0] as any, 0, 80).join("\n");
